...
mergesort(int arr[], const int *start, const int *end) //days of debug result: remember to make start=data, end=data+size-1, it is +(size-1), not (size), or you run in error
{
